    ...
    <div className="overflow-x-auto rounded-2xl shadow-lg border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-green-50 p-4">
      <div className="flex justify-end mb-2">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-green-400 text-white rounded-xl hover:from-blue-600 hover:to-green-500 transition font-semibold shadow focus:outline-none focus:ring-2 focus:ring-blue-300"
              ...
              >
                ...
                <td className="px-6 py-4 flex gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-4 py-2 bg-blue-500/90 text-white rounded-xl hover:bg-blue-600/90 transition-all duration-150 font-semibold shadow focus:outline-none focus:ring-2 focus:ring-blue-300"
                    title="Share"
                  >
                    <HiShare size={18} />
